...
(function(k) {
    ...
    function Ha(a,
        ...
        return b.map(function(d, e) { c = ab(a, e); return ea(a, c.data, e, c.cells) })
    }
    ...
    function Fa(a) {
        ...
        if (a.scrollBarVis !== ha && a.scrollBarVis !== q) a.scrollBarVis = ha, ra(a);
            ...
            }, ka), ba(function(F, Y) { F.style.width = aa[Y] }, la), k(ka).height(0));
            ba(function(F, Y) {
    ...
    function Wa(a) {
        k.each({ num: function(b) { return Ta(b, a) }, "num-fmt": function(b) { return Ta(b, a, rb) }, "html-num": function(b) { return Ta(b, a, Ua) }, "html-num-fmt": function(b) { return Ta(b, a, Ua, rb) } }, function(b, c) {
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "Mostrando _START_ de _END_ de _TOTAL_ anuncios",
            sInfoEmpty: "Mostrando 0 de 0 de 0 anuncios",
    ...
    k.extend(u.ext.type.detect, [function(a, b) { b = b.oLanguage.sDecimal; return tb(a, b) ? "num" + b : null }, function(a, b) {
